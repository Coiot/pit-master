    ...
    >
      <div class="xs-mt2 xs-p2 bcg-item">
        <div class="item xs-block xs-full-height">
          ...
          <div class="xs-pt3 post-content text-gray-lighter">
            <div v-html="$md.render(body)"></div>
          </div>
        </div>
      </div>
    </div>
    <div class="xs-p2 bcg-item single xs-border-left xs-border-right">
      <h3 class="secondary-title xs-pb2">All Posts</h3>
      <ul class="list-unstyled xs-flex xs-flex-row" style="flex-wrap: wrap">
        <li v-for="(pg,i) in blogPosts" :key="`pg-${i}`" class="xs-pr2 xs-pb2">
